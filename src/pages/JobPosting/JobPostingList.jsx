        ...
        <Table.Body>
          {postings.map((posting) => (
            <Table.Row key={posting.id}>
              <Table.Cell>{posting.jobPosition.title}</Table.Cell>
              <Table.Cell>{posting.employer.companyName}</Table.Cell>
              <Table.Cell>{posting.city.cityName}</Table.Cell>
              <Table.Cell>{posting.positionQuota}</Table.Cell>
              <Table.Cell>{posting.applicationDeadline}</Table.Cell>
              <Table.Cell>{posting.active.toString()}</Table.Cell>
              <Table.Cell>
                <Button>View</Button>
              </Table.Cell>
            </Table.Row>
